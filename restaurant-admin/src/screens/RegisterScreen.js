...
const RegisterScreen = ({ navigation }) => {
  ...
  const sendOtpUrl = `/public/send-otp-to-email?type=register&email=${email}`;
  ...
  useEffect(() => {
    if (data) {
      navigation.replace("VerifyOtp", { email: email, type: "registeration" });
    }
    ...
    <ScreenWrapper>
      <ScrollView automaticallyAdjustKeyboardInsets={true}>
        ...
        <View style={styles.container}>
          ...
          <Subheading>And spice up your food tales!</Subheading>
