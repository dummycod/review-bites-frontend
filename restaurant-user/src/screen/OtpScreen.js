...
const OtpScreen = ({ route, navigation }) => {
  ...
  var { contactNumber, type } = route.params;

  const verifyOtpUrl = `/public/verify-otp?contactNumber=${contactNumber}&otp=${otp.join(
    ""
  )}`;
    ...
    <ScreenWrapper>
      <ScrollView automaticallyAdjustKeyboardInsets={true}>
        ...
        <View style={styles.container}>
          <LottieView
            source={require("../../assets/animations/verify-otp.json")}
          ...
          <Subheading>Code dispatched to {"+91" + contactNumber}</Subheading>
